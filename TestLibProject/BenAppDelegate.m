...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSLog (@"%@", [Ben_LibClass getLibString]);
    TestLib *lib = [[TestLib alloc] init];
    lib.libName = @"This is a useless lib.";
    NSLog (@"%@", lib.libName);
    [self sayHelloWorld];
    
    self.window.backgroundColor = [UIColor whiteColor];
    self.window.rootViewController = [[NameClashesFinderVC alloc] init];
